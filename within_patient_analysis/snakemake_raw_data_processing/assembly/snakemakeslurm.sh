...
# --conda-prefix envs: builds environment in envs folder where it will be recycled whenever we re-do the Snakefile analysis in that specific parental folder!!! together with yaml file allows flawless reproducibility!!!
snakemake -p \
    $* \
     --latency-wait 30 \
    -j 600 \
